...
#define Light_Red			0xFA28

static uint16_t background_color = White;
static uint16_t text_color = Black;
static uint16_t top_background_color = Light_Red;

/*
	 0, MAX_Y-40					MAX_X/2, MAX_Y-40
	 x_0, y_0							x_1, y_0
	 ---------------------
	|			                |
	|			                |
...
void drawImage( uint16_t Xpos, uint16_t Ypos, Image *iron_man, uint16_t image[][2], uint16_t background_color, uint16_t refresh, uint16_t reverse_image);
