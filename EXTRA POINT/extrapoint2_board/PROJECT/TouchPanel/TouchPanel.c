...
void TouchPanel_Calibrate(void) {
  ...
  Coordinate * Ptr;
	...
	LCD_Clear(Black, 0, 0, MAX_X, MAX_Y);
  GUI_Text(10,10, (unsigned char*) "Touch crosshair to calibrate",0xffff,Black, 1); 
	
  for(i=0;i<3;i++) {    
		/*#ifndef SIMULATOR
		DelayUS(1000 * 500);			//for hardware machine
		DelayUS(1000 * 50);					//for landtiger
		#endif*/
