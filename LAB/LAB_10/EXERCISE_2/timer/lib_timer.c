...
uint32_t init_timer ( uint8_t timer_num, uint8_t mcr_value, uint8_t priority, uint32_t TimerIntervalMR0, uint32_t TimerIntervalMR1, uint32_t TimerIntervalMR2, uint32_t TimerIntervalMR3) {
  if ( timer_num == 0 ) {
		if(TimerIntervalMR0 != 0) {
			LPC_TIM0->MR0 = TimerIntervalMR0;
			LPC_TIM0->MCR = mcr_value;			
		} if(TimerIntervalMR1 != 0){
			LPC_TIM0->MR1 = TimerIntervalMR1;	
			LPC_TIM0->MCR = mcr_value;
		} if(TimerIntervalMR2 != 0){
			LPC_TIM0->MR2 = TimerIntervalMR2;	
			LPC_TIM0->MCR = mcr_value;
		} if(TimerIntervalMR3 != 0){
			LPC_TIM0->MR3 = TimerIntervalMR3;	
			LPC_TIM0->MCR = mcr_value;
		}
...
//  LPC_TIM0->PR = 20;
		...
		if(TimerIntervalMR0 != 0) {
			...
			LPC_TIM1->MCR = mcr_value;
		} if(TimerIntervalMR1 != 0){
			LPC_TIM1->MR1 = TimerIntervalMR1;	
			LPC_TIM1->MCR = mcr_value;
		} if(TimerIntervalMR2 != 0){
			LPC_TIM1->MR2 = TimerIntervalMR2;	
			LPC_TIM1->MCR = mcr_value;
		} if(TimerIntervalMR3 != 0){
			LPC_TIM1->MR3 = TimerIntervalMR3;	
			LPC_TIM1->MCR = mcr_value;
		}
		
		NVIC_EnableIRQ(TIMER1_IRQn);
		NVIC_SetPriority(TIMER1_IRQn, priority);	/* less priority than buttons and timer0*/
		return (1);
  } else if(timer_num == 2) {
		if(TimerIntervalMR0 != 0) {
			LPC_TIM2->MR0 = TimerIntervalMR0;	
			LPC_TIM2->MCR = mcr_value;			
		} if(TimerIntervalMR1 != 0){
			LPC_TIM2->MR1 = TimerIntervalMR1;	
			LPC_TIM2->MCR = mcr_value;
		} if(TimerIntervalMR2 != 0){
			LPC_TIM2->MR2 = TimerIntervalMR2;	
			LPC_TIM2->MCR = mcr_value;
		} if(TimerIntervalMR3 != 0){
			LPC_TIM2->MR3 = TimerIntervalMR3;	
			LPC_TIM2->MCR = mcr_value;
		}
		
		NVIC_EnableIRQ(TIMER2_IRQn);
		NVIC_SetPriority(TIMER2_IRQn, priority);	/* less priority than buttons and timer0*/

		return (1);
} else if(timer_num == 3) {
		if(TimerIntervalMR0 != 0) {
			LPC_TIM3->MR0 = TimerIntervalMR0;	
			LPC_TIM3->MCR = mcr_value;			
		} if(TimerIntervalMR1 != 0){
			LPC_TIM3->MR1 = TimerIntervalMR1;	
			LPC_TIM3->MCR = mcr_value;
		} if(TimerIntervalMR2 != 0){
			LPC_TIM3->MR2 = TimerIntervalMR2;	
			LPC_TIM3->MCR = mcr_value;
		} if(TimerIntervalMR3 != 0){
			LPC_TIM3->MR3 = TimerIntervalMR3;	
			LPC_TIM3->MCR = mcr_value;
		}
		
		NVIC_EnableIRQ(TIMER3_IRQn);
		NVIC_SetPriority(TIMER3_IRQn, priority);	/* less priority than buttons and timer0*/
		return (1);
	}
